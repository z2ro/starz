...
export const VISUAL_ASSETS: Record<string, VisualAssetDefinition> = {
  orbital_shipyard: { id: 'orbital_shipyard', type: 'station', path: '/static/models/orbital_shipyard.glb', scale: 0.18 },
  scout_hull: { id: 'scout_hull', type: 'ship', path: '/static/models/horizon.glb', scale: 0.45 },
};
