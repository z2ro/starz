type State = {
  ...
  capacities: { energy_generation: number; energy_consumption: number; industrial_capacity: number; construction_slots: number; construction_slots_available: number; shipyard_slots: number; shipyard_slots_available: number; effective_research_rate: number };
