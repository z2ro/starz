...
| empire | UUID, universo, sistema inicial, nome placeholder, last_updated |
| planet_state | UUID, owner, sistema e população mutável |
...
spawn determinístico, planeta, stocks, distritos e pesquisa vazia. Reinício não reseta seed.
