...
![Prancha conceitual Horizon](assets/horizon-concept.png)

## Função

Exploração, reconhecimento e levantamento de sistemas.

## Silhueta e arquitetura

Casco estreito e leve, proa alongada, cabine frontal e conjunto traseiro de três motores. Aletas e módulos de sensores dão leitura de mobilidade.

É a referência de menor porte da família militar/exploratória. Preservar a leveza e a identificação HORIZON no casco.

## Regiões funcionais

- Cabine e operações na proa.
- Sensores e equipamento de levantamento.
- Núcleo técnico, painéis de serviço, motores e estabilizadores.
