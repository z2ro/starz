...
test('asset manifest resolves local station and Horizon paths', () => {
  ...
  assert.equal(registry.definition('orbital_shipyard').path, '/static/models/orbital_shipyard.glb');
  assert.equal(registry.definition('scout_hull').path, '/static/models/horizon.glb');
